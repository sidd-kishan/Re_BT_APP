...
static final class ParallelMapTry.ParallelMapTryConditionalSubscriber<T, R>
...
Subscription {
    ...
    ParallelMapTry.ParallelMapTryConditionalSubscriber(ConditionalSubscriber<? super R> conditionalSubscriber, Function<? super T, ? extends R> function, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
    ...
    public boolean tryOnNext(T t) {
        ...
        while (true) {
            try {
                Object object = ObjectHelper.requireNonNull((Object)this.mapper.apply(t), (String)"The mapper returned a null value");
