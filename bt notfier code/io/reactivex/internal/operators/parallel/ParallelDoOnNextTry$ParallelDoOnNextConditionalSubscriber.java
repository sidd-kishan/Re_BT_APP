...
static final class ParallelDoOnNextTry.ParallelDoOnNextConditionalSubscriber<T>
...
Subscription {
    ...
    ParallelDoOnNextTry.ParallelDoOnNextConditionalSubscriber(ConditionalSubscriber<? super T> conditionalSubscriber, Consumer<? super T> consumer, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
