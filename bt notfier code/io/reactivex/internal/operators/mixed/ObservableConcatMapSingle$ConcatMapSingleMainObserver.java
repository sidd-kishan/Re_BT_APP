...
Disposable {
    ...
    ObservableConcatMapSingle.ConcatMapSingleMainObserver(Observer<? super R> observer, Function<? super T, ? extends SingleSource<? extends R>> function, int n, ErrorMode errorMode) {
        ...
        while (true) {
            ...
            if (this.cancelled) {
                ...
                if (n3 == 0) {
                    ...
                    if (n2 == 0) {
                        try {
                            object2 = (SingleSource)ObjectHelper.requireNonNull((Object)this.mapper.apply(object2), (String)"The mapper returned a null SingleSource");
                            this.state = 1;
                        }
