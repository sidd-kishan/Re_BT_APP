...
static final class SingleFlatMapObservable.FlatMapObserver<T, R>
...
Disposable {
    ...
    SingleFlatMapObservable.FlatMapObserver(Observer<? super R> observer, Function<? super T, ? extends ObservableSource<? extends R>> function) {
