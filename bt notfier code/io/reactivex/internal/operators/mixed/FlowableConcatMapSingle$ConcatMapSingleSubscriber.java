...
Subscription {
    ...
    FlowableConcatMapSingle.ConcatMapSingleSubscriber(Subscriber<? super R> subscriber, Function<? super T, ? extends SingleSource<? extends R>> function, int n, ErrorMode errorMode) {
