...
static final class FlowableDoFinally.DoFinallyConditionalSubscriber<T>
...
implements ConditionalSubscriber<T> {
    ...
    FlowableDoFinally.DoFinallyConditionalSubscriber(ConditionalSubscriber<? super T> conditionalSubscriber, Action action) {
