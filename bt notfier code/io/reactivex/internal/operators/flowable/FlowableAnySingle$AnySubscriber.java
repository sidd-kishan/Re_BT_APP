...
static final class FlowableAnySingle.AnySubscriber<T>
...
Disposable {
    ...
    FlowableAnySingle.AnySubscriber(SingleObserver<? super Boolean> singleObserver, Predicate<? super T> predicate) {
