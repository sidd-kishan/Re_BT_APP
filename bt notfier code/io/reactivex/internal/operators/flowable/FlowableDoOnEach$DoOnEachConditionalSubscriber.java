...
static final class FlowableDoOnEach.DoOnEachConditionalSubscriber<T>
extends BasicFuseableConditionalSubscriber<T, T> {
    ...
    FlowableDoOnEach.DoOnEachConditionalSubscriber(ConditionalSubscriber<? super T> conditionalSubscriber, Consumer<? super T> consumer, Consumer<? super Throwable> consumer2, Action action, Action action2) {
        ...
        block11: {
            ...
            try {
                ...
                this.onError.accept((Object)throwable);
                {
                        ...
                        object = new CompositeException(new Throwable[]{throwable, throwable3});
                        throw object;
                    }
                }
