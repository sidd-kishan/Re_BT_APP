...
static final class ObservableRepeatWhen.RepeatWhenObserver<T>
...
Disposable {
    ...
    ObservableRepeatWhen.RepeatWhenObserver(Observer<? super T> observer, Subject<Object> subject, ObservableSource<T> observableSource) {
    ...
    public void onComplete() {
        ...
        this.active = false;
        this.signaller.onNext((Object)0);
    }
