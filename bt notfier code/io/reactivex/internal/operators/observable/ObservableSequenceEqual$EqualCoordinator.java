...
static final class ObservableSequenceEqual.EqualCoordinator<T>
...
implements Disposable {
    ...
    ObservableSequenceEqual.EqualCoordinator(Observer<? super Boolean> equalObserverArray, int n, ObservableSource<? extends T> observableSource, ObservableSource<? extends T> observableSource2, BiPredicate<? super T, ? super T> biPredicate) {
        this.downstream = equalObserverArray;
        this.first = observableSource;
        this.second = observableSource2;
        this.comparer = biPredicate;
        equalObserverArray = new ObservableSequenceEqual.EqualObserver[2];
        this.observers = equalObserverArray;
        equalObserverArray[0] = new ObservableSequenceEqual.EqualObserver(this, 0, n);
        equalObserverArray[1] = new ObservableSequenceEqual.EqualObserver(this, 1, n);
    ...
    public void dispose() {
        ...
        ObservableSequenceEqual.EqualObserver<T>[] equalObserverArray = this.observers;
    ...
    void drain() {
        ...
        ObservableSequenceEqual.EqualObserver<T> equalObserver = spscLinkedArrayQueue[0];
        SpscLinkedArrayQueue spscLinkedArrayQueue2 = equalObserver.queue;
        ObservableSequenceEqual.EqualObserver<T> equalObserver2 = spscLinkedArrayQueue[1];
        ...
        while (true) {
            ...
            if (n2 == 0 && !n3) {
                block12: {
                    try {
                        bl = this.comparer.test(this.v1, this.v2);
                        if (bl) break block12;
                        this.cancel(spscLinkedArrayQueue2, spscLinkedArrayQueue);
                    }
