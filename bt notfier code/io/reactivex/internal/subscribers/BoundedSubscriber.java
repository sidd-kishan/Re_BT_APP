...
LambdaConsumerIntrospection {
    ...
    public BoundedSubscriber(Consumer<? super T> consumer, Consumer<? super Throwable> consumer2, Action action, Consumer<? super Subscription> consumer3, int n) {
    ...
    public void onNext(T t) {
        ...
        try {
            ...
            if (n == this.limit) {
                this.consumed = 0;
                ((Subscription)this.get()).request((long)this.limit);
            } else {
                this.consumed = n;
            }
        }
