...
extends DiskLruCacheFactory {
    ...
    public ExternalCacheDiskCacheFactory(Context context, String string, int n) {
        super((DiskLruCacheFactory.CacheDirectoryGetter)new /* Unavailable Anonymous Inner Class!! */, (long)n);
    }
}
