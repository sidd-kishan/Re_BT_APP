...
implements zzgla<zzegf> {
    ...
    public zzegg(zzgln<Context> zzgln2, zzgln<zzcgz> zzgln3, zzgln<zzfar> zzgln4, zzgln<Executor> zzgln5, zzgln<zzdkf> zzgln6, zzgln<zzdss> zzgln7, zzgln<zzbpu> zzgln8) {
        this.zza = zzgln2;
        this.zzb = zzgln3;
        this.zzc = zzgln4;
        this.zzd = zzgln5;
