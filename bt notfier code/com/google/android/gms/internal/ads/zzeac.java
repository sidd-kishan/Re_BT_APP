    ...
    public final void onConnected(Bundle object) {
        ...
        synchronized (object) {
            ...
            try {
                ...
                zzcbb2.zzf(zzcbj2, (zzcbf)zzdzz2);
            }
            catch (Throwable throwable) {
                zzt.zzg().zzk(throwable, "RemoteSignalsClientTask.onConnected");
                zzchl zzcbj2 = this.zza;
                zzeap zzeap2 = new zzeap(1);
                zzcbj2.zzd((Throwable)zzeap2);
            }
            catch (RemoteException | IllegalArgumentException throwable) {
                zzchl zzchl2 = this.zza;
                zzeap zzeap3 = new zzeap(1);
                zzchl2.zzd((Throwable)zzeap3);
            }
            return;
        }
    }
