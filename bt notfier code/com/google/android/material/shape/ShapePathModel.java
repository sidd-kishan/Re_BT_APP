...
public class ShapePathModel {
    ...
    public ShapePathModel() {
        ...
        this.topLeftCorner = cornerTreatment = DEFAULT_CORNER_TREATMENT;
        this.topRightCorner = cornerTreatment;
        this.bottomRightCorner = cornerTreatment;
        this.bottomLeftCorner = cornerTreatment;
        cornerTreatment = DEFAULT_EDGE_TREATMENT;
        this.topEdge = cornerTreatment;
        this.rightEdge = cornerTreatment;
        this.bottomEdge = cornerTreatment;
        this.leftEdge = cornerTreatment;
    }
