...
class UserInfoActivity_ViewBinding.1
extends DebouncingOnClickListener {
    final UserInfoActivity_ViewBinding this$0;
    final UserInfoActivity val$target;

    UserInfoActivity_ViewBinding.1(UserInfoActivity_ViewBinding userInfoActivity_ViewBinding, UserInfoActivity userInfoActivity) {
