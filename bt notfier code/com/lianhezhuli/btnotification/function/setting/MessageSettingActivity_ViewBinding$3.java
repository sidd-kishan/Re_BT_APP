...
class MessageSettingActivity_ViewBinding.3
extends DebouncingOnClickListener {
    final MessageSettingActivity_ViewBinding this$0;
    final MessageSettingActivity val$target;

    MessageSettingActivity_ViewBinding.3(MessageSettingActivity_ViewBinding messageSettingActivity_ViewBinding, MessageSettingActivity messageSettingActivity) {
