...
private static class QMUILinkify.WebUrlPattern {
    ...
    static {
        ...
        while (true) {
            if (n >= EXT.length) {
                ...
                stringBuilder.append("((?:(www\\.|[a-zA-Z\\.\\-]+\\.)?[a-zA-Z0-9\\-]+)\\.");
                stringBuilder.append(charSequence.toString());
                stringBuilder.append(")");
                charSequence = stringBuilder.toString();
                stringBuilder = new StringBuilder();
                stringBuilder.append("(((?i:http|https|rtsp)://)?(((25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}|[1-9][0-9]|[1-9])\\.(25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}|[1-9][0-9]|[1-9]|0)\\.(25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}|[1-9][0-9]|[1-9]|0)\\.(25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}|[1-9][0-9]|[0-9]))|");
                stringBuilder.append((String)charSequence);
                stringBuilder.append(")(");
                stringBuilder.append(PORT_NUMBER);
                stringBuilder.append(")?(");
                stringBuilder.append(PATH_AND_QUERY);
                stringBuilder.append(")?)");
            ...
            charSequence.append(EXT[n]);
            ++n;
        }
    }

    private QMUILinkify.WebUrlPattern() {
    }
