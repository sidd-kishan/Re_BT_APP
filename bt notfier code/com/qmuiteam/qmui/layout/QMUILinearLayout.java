...
implements IQMUILayout {
    ...
    public QMUILinearLayout(Context context, AttributeSet attributeSet, int n) {
    ...
    protected void onMeasure(int n, int n2) {
        ...
        int n4 = this.mLayoutHelper.handleMiniWidth(n, this.getMeasuredWidth());
        n2 = this.mLayoutHelper.handleMiniHeight(n3, this.getMeasuredHeight());
        if (n == n4) {
            if (n3 == n2) return;
        }
