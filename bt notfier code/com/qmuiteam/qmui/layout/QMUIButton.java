...
implements IQMUILayout {
    ...
    public QMUIButton(Context context, AttributeSet attributeSet, int n) {
    ...
    protected void onMeasure(int n, int n2) {
        ...
        int n3 = this.mLayoutHelper.getMeasuredHeightSpec(n2);
        super.onMeasure(n, n3);
        n2 = this.mLayoutHelper.handleMiniWidth(n, this.getMeasuredWidth());
        int n4 = this.mLayoutHelper.handleMiniHeight(n3, this.getMeasuredHeight());
        if (n == n2) {
            if (n3 == n4) return;
        }
