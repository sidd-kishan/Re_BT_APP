...
public final class Hpack {
    ...
    private final Map<ByteString, Integer> nameToFirstIndex() {
        ...
        int n = STATIC_HEADER_TABLE.length - 1;
        if (n >= 0) {
            int n2 = 0;
            while (true) {
                int n3 = n2 + 1;
        ...
        Intrinsics.checkNotNullExpressionValue(linkedHashMap, (String)"unmodifiableMap(result)");
    ...
    public final ByteString checkLowercase(ByteString byteString) throws IOException {
        ...
        while (true) {
            ...
            int n4 = 65;
            byte by = (byte)90;
            n2 = n4 <= (n2 = (int)byteString.getByte(n2)) && n2 <= by ? 1 : 0;
            if (n2 != 0) throw new IOException(Intrinsics.stringPlus((String)"PROTOCOL_ERROR response malformed: mixed case name: ", (Object)byteString.utf8()));
            if (n3 >= n) {
                return byteString;
            }
            n2 = n3;
