...
ImageOutputConfig,
ThreadConfig {
    public static final Config.Option<ImageInfoProcessor> IMAGE_INFO_PROCESSOR = Config.Option.create((String)"camerax.core.preview.imageInfoProcessor", ImageInfoProcessor.class);
    public static final Config.Option<CaptureProcessor> OPTION_PREVIEW_CAPTURE_PROCESSOR = Config.Option.create((String)"camerax.core.preview.captureProcessor", CaptureProcessor.class);
    ...
    public CaptureProcessor getCaptureProcessor(CaptureProcessor captureProcessor) {
        return this.retrieveOption(OPTION_PREVIEW_CAPTURE_PROCESSOR, captureProcessor);
    }
    ...
    public ImageInfoProcessor getImageInfoProcessor(ImageInfoProcessor imageInfoProcessor) {
        return this.retrieveOption(IMAGE_INFO_PROCESSOR, imageInfoProcessor);
    }
