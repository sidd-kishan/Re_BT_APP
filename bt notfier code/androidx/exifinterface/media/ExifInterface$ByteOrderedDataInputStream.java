...
private static class ExifInterface.ByteOrderedDataInputStream
extends InputStream
implements DataInput {
    ...
    ExifInterface.ByteOrderedDataInputStream(InputStream inputStream, ByteOrder byteOrder) throws IOException {
        int n;
    ...
    public ExifInterface.ByteOrderedDataInputStream(byte[] byArray) throws IOException {
    ...
    public int readInt() throws IOException {
        ...
        int n3;
        int n4;
        this.mPosition = n4 = this.mPosition + 4;
        if (n4 > this.mLength) throw new EOFException();
        n4 = this.mDataInputStream.read();
