...
public class AccessibilityRecordCompat {
    ...
    public static int getMaxScrollX(AccessibilityRecord accessibilityRecord) {
        if (Build.VERSION.SDK_INT < 15) return 0;
    ...
    public boolean equals(Object object) {
        ...
        AccessibilityRecordCompat accessibilityRecordCompat = (AccessibilityRecordCompat)object;
        object = this.mRecord;
        if (object == null) {
            if (accessibilityRecordCompat.mRecord == null) return true;
            return false;
        }
        if (object.equals(accessibilityRecordCompat.mRecord)) return true;
        return false;
    }
    ...
    public int hashCode() {
        ...
        int n = accessibilityRecord == null ? 0 : accessibilityRecord.hashCode();
        return n;
    }
