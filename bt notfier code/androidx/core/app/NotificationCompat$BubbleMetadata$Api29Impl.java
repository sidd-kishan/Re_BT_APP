...
private static class NotificationCompat.BubbleMetadata.Api29Impl {
    ...
    static NotificationCompat.BubbleMetadata fromPlatform(Notification.BubbleMetadata bubbleMetadata) {
        ...
        NotificationCompat.BubbleMetadata.Builder builder = new NotificationCompat.BubbleMetadata.Builder(bubbleMetadata.getIntent(), IconCompat.createFromIcon((Icon)bubbleMetadata.getIcon())).setAutoExpandBubble(bubbleMetadata.getAutoExpandBubble()).setDeleteIntent(bubbleMetadata.getDeleteIntent()).setSuppressNotification(bubbleMetadata.isNotificationSuppressed());
