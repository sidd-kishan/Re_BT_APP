...
class LocationManagerCompat.PreRGnssStatusTransport.1
implements Runnable {
    final LocationManagerCompat.PreRGnssStatusTransport this$0;
    final Executor val$executor;

    LocationManagerCompat.PreRGnssStatusTransport.1(LocationManagerCompat.PreRGnssStatusTransport preRGnssStatusTransport, Executor executor) {
