...
class LocationManagerCompat.GpsStatusTransport.1
implements Runnable {
    final LocationManagerCompat.GpsStatusTransport this$0;
    final Executor val$executor;

    LocationManagerCompat.GpsStatusTransport.1(LocationManagerCompat.GpsStatusTransport gpsStatusTransport, Executor executor) {
