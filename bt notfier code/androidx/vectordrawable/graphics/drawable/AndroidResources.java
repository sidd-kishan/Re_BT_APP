...
class AndroidResources {
    ...
    static {
        STYLEABLE_VECTOR_DRAWABLE_TYPE_ARRAY = new int[]{0x1010003, 0x1010121, 0x1010155, 16843097, 16843551, 16843754, 16843771, 16843778, 16843779};
        STYLEABLE_VECTOR_DRAWABLE_GROUP = new int[]{0x1010003, 16843189, 16843190, 16843556, 16843557, 16843558, 16843866, 16843867};
        STYLEABLE_VECTOR_DRAWABLE_PATH = new int[]{0x1010003, 0x1010404, 16843781, 16843782, 16843783, 16843784, 16843785, 16843786, 16843787, 16843788, 16843789, 16843979, 16843980, 16844062};
        STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH = new int[]{0x1010003, 16843781, 16844062};
        STYLEABLE_ANIMATED_VECTOR_DRAWABLE = new int[]{0x1010199};
        STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET = new int[]{0x1010003, 16843213};
        STYLEABLE_ANIMATOR = new int[]{0x1010141, 16843160, 16843198, 16843199, 0x10101C0, 16843486, 16843487, 16843488};
        STYLEABLE_ANIMATOR_SET = new int[]{16843490};
        STYLEABLE_PROPERTY_VALUES_HOLDER = new int[]{16843486, 16843487, 16843488, 16843489};
        STYLEABLE_KEYFRAME = new int[]{16842788, 0x1010141, 16843488, 16843992};
