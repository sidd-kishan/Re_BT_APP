...
static final class ParameterHandler.Field<T>
extends ParameterHandler<T> {
    private final boolean encoded;
    private final String name;
    private final Converter<T, String> valueConverter;

    ParameterHandler.Field(String string, Converter<T, String> converter, boolean bl) {
    ...
    void apply(RequestBuilder requestBuilder, @Nullable T object) throws IOException {
        ...
        requestBuilder.addFormField(this.name, object, this.encoded);
    }
}
