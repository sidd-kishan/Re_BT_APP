...
implements CoroutineContext.Key<E> {
    ...
    public AbstractCoroutineContextKey(CoroutineContext.Key<B> key, Function1<? super CoroutineContext.Element, ? extends E> function1) {
        Intrinsics.checkNotNullParameter(key, (String)"baseKey");
        Intrinsics.checkNotNullParameter(function1, (String)"safeCast");
        this.safeCast = function1;
        function1 = key;
        if (key instanceof AbstractCoroutineContextKey) {
            function1 = ((AbstractCoroutineContextKey)key).topmostKey;
        }
        this.topmostKey = function1;
    }

    public final boolean isSubKey$kotlin_stdlib(CoroutineContext.Key<?> key) {
        Intrinsics.checkNotNullParameter(key, (String)"key");
        boolean bl = key == this || this.topmostKey == key;
        return bl;
    }

    public final E tryCast$kotlin_stdlib(CoroutineContext.Element element) {
        Intrinsics.checkNotNullParameter((Object)element, (String)"element");
        return (E)((CoroutineContext.Element)this.safeCast.invoke((Object)element));
    }
}
