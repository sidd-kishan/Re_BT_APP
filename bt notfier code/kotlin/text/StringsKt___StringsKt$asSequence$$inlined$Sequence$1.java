...
public static final class StringsKt___StringsKt$asSequence$.inlined.Sequence.1
implements Sequence<Character> {
    ...
    public Iterator<Character> iterator() {
        return (Iterator)StringsKt.iterator((CharSequence)this.$this_asSequence$inlined);
    }
}
