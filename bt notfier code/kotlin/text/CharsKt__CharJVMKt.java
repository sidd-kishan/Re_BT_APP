...
class CharsKt__CharJVMKt {
    ...
    public static final CharDirectionality getDirectionality(char c) {
        return CharDirectionality.Companion.valueOf((int)Character.getDirectionality(c));
    }
    ...
    public static final String titlecase(char c, Locale object) {
        Intrinsics.checkNotNullParameter((Object)object, (String)"locale");
        object = CharsKt.uppercase((char)c, (Locale)object);
        if (((String)object).length() <= 1) {
            String string = String.valueOf(c);
            if (string == null) throw new NullPointerException("null cannot be cast to non-null type java.lang.String");
            string = string.toUpperCase(Locale.ROOT);
            Intrinsics.checkNotNullExpressionValue((Object)string, (String)"(this as java.lang.Strin\u2026.toUpperCase(Locale.ROOT)");
            if (!(Intrinsics.areEqual((Object)object, (Object)string) ^ true)) return String.valueOf(Character.toTitleCase(c));
            return object;
        }
        if (c == '\u0149') return object;
