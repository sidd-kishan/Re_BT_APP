...
public abstract class DeepRecursiveScope<T, R> {
    ...
    public abstract Object callRecursive(T var1, Continuation<? super R> var2);

    public abstract <U, S> Object callRecursive(DeepRecursiveFunction<U, S> var1, U var2, Continuation<? super S> var3);
    ...
    public final Void invoke(DeepRecursiveFunction<?, ?> deepRecursiveFunction, Object object) {
        Intrinsics.checkNotNullParameter(deepRecursiveFunction, (String)"$this$invoke");
        throw (Throwable)new UnsupportedOperationException("Should not be called from DeepRecursiveScope");
    }
}
