...
public static final class ComparisonsKt__ComparisonsKt.thenBy.1<T>
implements Comparator {
    ...
    public final int compare(T t, T t2) {
        ...
        if (n != 0) return n;
        n = ComparisonsKt.compareValues((Comparable)((Comparable)this.$selector.invoke(t)), (Comparable)((Comparable)this.$selector.invoke(t2)));
        return n;
    }
}
