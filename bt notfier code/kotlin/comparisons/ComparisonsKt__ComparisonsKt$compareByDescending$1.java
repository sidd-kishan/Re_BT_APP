...
public static final class ComparisonsKt__ComparisonsKt.compareByDescending.1<T>
implements Comparator {
    ...
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues((Comparable)((Comparable)this.$selector.invoke(t2)), (Comparable)((Comparable)this.$selector.invoke(t)));
    }
}
