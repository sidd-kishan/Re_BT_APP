...
public static final class ComparisonsKt__ComparisonsKt.compareBy.2<T>
implements Comparator {
    ...
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues((Comparable)((Comparable)this.$selector.invoke(t)), (Comparable)((Comparable)this.$selector.invoke(t2)));
    }
}
