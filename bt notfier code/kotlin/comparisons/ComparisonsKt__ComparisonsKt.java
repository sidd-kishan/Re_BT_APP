...
class ComparisonsKt__ComparisonsKt {
    ...
    public static final <T> Comparator<T> compareBy(Function1<? super T, ? extends Comparable<?>> ... function1Array) {
        Intrinsics.checkNotNullParameter(function1Array, (String)"selectors");
    ...
    public static final <T extends Comparable<?>> int compareValues(T t, T t2) {
        ...
        if (t2 != null) return t.compareTo(t2);
        return 1;
    }
    ...
    private static final <T> int compareValuesBy(T t, T t2, Function1<? super T, ? extends Comparable<?>> function1) {
        return ComparisonsKt.compareValues((Comparable)((Comparable)function1.invoke(t)), (Comparable)((Comparable)function1.invoke(t2)));
    }
    ...
    private static final <T> int compareValuesByImpl$ComparisonsKt__ComparisonsKt(T t, T t2, Function1<? super T, ? extends Comparable<?>>[] function1Array) {
        ...
        int n2 = 0;
        while (n2 < n) {
            Function1<? super T, ? extends Comparable<?>> function1 = function1Array[n2];
            int n3 = ComparisonsKt.compareValues((Comparable)((Comparable)function1.invoke(t)), (Comparable)((Comparable)function1.invoke(t2)));
            if (n3 != 0) {
                return n3;
            }
            ++n2;
    ...
    private static final <T extends Comparable<? super T>> Comparator<T> nullsFirst() {
        return ComparisonsKt.nullsFirst((Comparator)ComparisonsKt.naturalOrder());
    }
    ...
    private static final <T extends Comparable<? super T>> Comparator<T> nullsLast() {
        return ComparisonsKt.nullsLast((Comparator)ComparisonsKt.naturalOrder());
    }
    ...
    public static final <T extends Comparable<? super T>> Comparator<T> reverseOrder() {
        ...
        return (Comparator)reverseOrderComparator;
    }

    public static final <T> Comparator<T> reversed(Comparator<T> comparator) {
        Intrinsics.checkNotNullParameter(comparator, (String)"$this$reversed");
        if (comparator instanceof ReversedComparator) {
            comparator = ((ReversedComparator)comparator).getComparator();
        } else if (Intrinsics.areEqual(comparator, (Object)NaturalOrderComparator.INSTANCE)) {
            comparator = ReverseOrderComparator.INSTANCE;
            if (comparator == null) throw new NullPointerException("null cannot be cast to non-null type kotlin.Comparator<T> /* = java.util.Comparator<T> */");
            ...
            comparator = (Comparator)new ReversedComparator(comparator);
        }
        return comparator;
    }

    public static final <T> Comparator<T> then(Comparator<T> comparator, Comparator<? super T> comparator2) {
        Intrinsics.checkNotNullParameter(comparator, (String)"$this$then");
    ...
    public static final <T> Comparator<T> thenDescending(Comparator<T> comparator, Comparator<? super T> comparator2) {
        Intrinsics.checkNotNullParameter(comparator, (String)"$this$thenDescending");
        Intrinsics.checkNotNullParameter(comparator2, (String)"comparator");
        return (Comparator)new /* Unavailable Anonymous Inner Class!! */;
    }
}
