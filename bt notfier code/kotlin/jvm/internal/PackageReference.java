...
implements ClassBasedDeclarationContainer {
    ...
    public PackageReference(Class<?> clazz, String string) {
        Intrinsics.checkNotNullParameter(clazz, (String)"jClass");
        Intrinsics.checkNotNullParameter((Object)string, (String)"moduleName");
        this.jClass = clazz;
        this.moduleName = string;
    }

    public boolean equals(Object object) {
        boolean bl = object instanceof PackageReference && Intrinsics.areEqual(this.getJClass(), ((PackageReference)object).getJClass());
        return bl;
    }
