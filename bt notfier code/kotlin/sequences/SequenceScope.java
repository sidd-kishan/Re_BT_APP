...
public abstract class SequenceScope<T> {
    ...
    public final Object yieldAll(Iterable<? extends T> object, Continuation<? super Unit> continuation) {
        if (object instanceof Collection && ((Collection)object).isEmpty()) {
            return Unit.INSTANCE;
        }
        if ((object = this.yieldAll(object.iterator(), continuation)) != IntrinsicsKt.getCOROUTINE_SUSPENDED()) return Unit.INSTANCE;
        return object;
    }

    public abstract Object yieldAll(Iterator<? extends T> var1, Continuation<? super Unit> var2);

    public final Object yieldAll(Sequence<? extends T> object, Continuation<? super Unit> continuation) {
        if ((object = this.yieldAll(object.iterator(), continuation)) != IntrinsicsKt.getCOROUTINE_SUSPENDED()) return Unit.INSTANCE;
        return object;
    }
}
