...
public static final class DropSequence.iterator.1
...
KMappedMarker {
    ...
    DropSequence.iterator.1(DropSequence dropSequence) {
        ...
        this.iterator = DropSequence.access$getSequence$p((DropSequence)dropSequence).iterator();
        this.left = DropSequence.access$getCount$p((DropSequence)dropSequence);
    }
