...
public static final class MergingSequence.iterator.1
...
KMappedMarker {
    ...
    MergingSequence.iterator.1(MergingSequence mergingSequence) {
        ...
        this.iterator1 = MergingSequence.access$getSequence1$p((MergingSequence)mergingSequence).iterator();
        this.iterator2 = MergingSequence.access$getSequence2$p((MergingSequence)mergingSequence).iterator();
    }
    ...
    @Override
    public V next() {
        return MergingSequence.access$getTransform$p((MergingSequence)this.this$0).invoke(this.iterator1.next(), this.iterator2.next());
    }
