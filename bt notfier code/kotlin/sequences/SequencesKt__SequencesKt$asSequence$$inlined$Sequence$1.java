...
public static final class SequencesKt__SequencesKt$asSequence$.inlined.Sequence.1
implements Sequence<T> {
    final Iterator $this_asSequence$inlined;

    public SequencesKt__SequencesKt$asSequence$.inlined.Sequence.1(Iterator iterator) {
        this.$this_asSequence$inlined = iterator;
    }
