...
public static final class ArraysKt___ArraysJvmKt.asList.4
extends AbstractList<Long>
implements RandomAccess {
    final long[] $this_asList;

    ArraysKt___ArraysJvmKt.asList.4(long[] lArray) {
        this.$this_asList = lArray;
    }

    public boolean contains(long l) {
        return ArraysKt.contains((long[])this.$this_asList, (long)l);
    }
