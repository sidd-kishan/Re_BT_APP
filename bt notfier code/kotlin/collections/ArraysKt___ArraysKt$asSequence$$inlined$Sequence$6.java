...
public static final class ArraysKt___ArraysKt$asSequence$.inlined.Sequence.6
implements Sequence<Float> {
    final float[] $this_asSequence$inlined;

    public ArraysKt___ArraysKt$asSequence$.inlined.Sequence.6(float[] fArray) {
        this.$this_asSequence$inlined = fArray;
    }

    public Iterator<Float> iterator() {
        return (Iterator)ArrayIteratorsKt.iterator((float[])this.$this_asSequence$inlined);
    }
}
