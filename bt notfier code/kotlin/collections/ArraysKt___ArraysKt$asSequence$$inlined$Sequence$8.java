...
public static final class ArraysKt___ArraysKt$asSequence$.inlined.Sequence.8
implements Sequence<Boolean> {
    final boolean[] $this_asSequence$inlined;

    public ArraysKt___ArraysKt$asSequence$.inlined.Sequence.8(boolean[] blArray) {
        this.$this_asSequence$inlined = blArray;
    }

    public Iterator<Boolean> iterator() {
        return (Iterator)ArrayIteratorsKt.iterator((boolean[])this.$this_asSequence$inlined);
    }
}
