...
public static final class ArraysKt___ArraysKt$asSequence$.inlined.Sequence.4
implements Sequence<Integer> {
    final int[] $this_asSequence$inlined;

    public ArraysKt___ArraysKt$asSequence$.inlined.Sequence.4(int[] nArray) {
        this.$this_asSequence$inlined = nArray;
    }

    public Iterator<Integer> iterator() {
        return (Iterator)ArrayIteratorsKt.iterator((int[])this.$this_asSequence$inlined);
    }
}
