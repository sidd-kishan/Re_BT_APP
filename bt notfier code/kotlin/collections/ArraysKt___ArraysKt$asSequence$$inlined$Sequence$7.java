...
public static final class ArraysKt___ArraysKt$asSequence$.inlined.Sequence.7
implements Sequence<Double> {
    final double[] $this_asSequence$inlined;

    public ArraysKt___ArraysKt$asSequence$.inlined.Sequence.7(double[] dArray) {
        this.$this_asSequence$inlined = dArray;
    }

    public Iterator<Double> iterator() {
        return (Iterator)ArrayIteratorsKt.iterator((double[])this.$this_asSequence$inlined);
    }
}
