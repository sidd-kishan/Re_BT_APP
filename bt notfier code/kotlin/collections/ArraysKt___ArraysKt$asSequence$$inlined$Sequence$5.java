...
public static final class ArraysKt___ArraysKt$asSequence$.inlined.Sequence.5
implements Sequence<Long> {
    final long[] $this_asSequence$inlined;

    public ArraysKt___ArraysKt$asSequence$.inlined.Sequence.5(long[] lArray) {
        this.$this_asSequence$inlined = lArray;
    }

    public Iterator<Long> iterator() {
        return (Iterator)ArrayIteratorsKt.iterator((long[])this.$this_asSequence$inlined);
    }
}
