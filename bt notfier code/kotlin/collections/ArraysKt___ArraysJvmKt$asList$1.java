...
public static final class ArraysKt___ArraysJvmKt.asList.1
extends AbstractList<Byte>
implements RandomAccess {
    final byte[] $this_asList;

    ArraysKt___ArraysJvmKt.asList.1(byte[] byArray) {
        this.$this_asList = byArray;
    }

    public boolean contains(byte by) {
        return ArraysKt.contains((byte[])this.$this_asList, (byte)by);
    }
