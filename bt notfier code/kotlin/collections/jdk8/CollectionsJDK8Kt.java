...
public final class CollectionsJDK8Kt {
    private static final <K, V> V getOrDefault(Map<? extends K, ? extends V> map, K k, V v) {
        if (map == null) throw new NullPointerException("null cannot be cast to non-null type kotlin.collections.Map<K, V>");
        return map.getOrDefault(k, v);
    }

    private static final <K, V> boolean remove(Map<? extends K, ? extends V> map, K k, V v) {
        if (map == null) throw new NullPointerException("null cannot be cast to non-null type kotlin.collections.MutableMap<K, V>");
