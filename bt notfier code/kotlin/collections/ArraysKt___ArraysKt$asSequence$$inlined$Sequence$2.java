...
public static final class ArraysKt___ArraysKt$asSequence$.inlined.Sequence.2
implements Sequence<Byte> {
    final byte[] $this_asSequence$inlined;

    public ArraysKt___ArraysKt$asSequence$.inlined.Sequence.2(byte[] byArray) {
        this.$this_asSequence$inlined = byArray;
    }

    public Iterator<Byte> iterator() {
        return (Iterator)ArrayIteratorsKt.iterator((byte[])this.$this_asSequence$inlined);
    }
}
