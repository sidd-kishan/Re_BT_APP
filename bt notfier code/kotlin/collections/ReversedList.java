...
extends AbstractMutableList<T> {
    ...
    public ReversedList(List<T> list) {
        Intrinsics.checkNotNullParameter(list, (String)"delegate");
        this.delegate = list;
    }

    public void add(int n, T t) {
        this.delegate.add(CollectionsKt__ReversedViewsKt.access$reversePositionIndex((List)((Object)this), (int)n), t);
    }
    ...
    public T get(int n) {
        return this.delegate.get(CollectionsKt__ReversedViewsKt.access$reverseElementIndex((List)((Object)this), (int)n));
    }
    ...
    public T removeAt(int n) {
        return this.delegate.remove(CollectionsKt__ReversedViewsKt.access$reverseElementIndex((List)((Object)this), (int)n));
    }

    public T set(int n, T t) {
        return this.delegate.set(CollectionsKt__ReversedViewsKt.access$reverseElementIndex((List)((Object)this), (int)n), t);
    }
}
