...
class ArraysKt__ArraysJVMKt {
    public static final <T> T[] arrayOfNulls(T[] object, int n) {
        Intrinsics.checkNotNullParameter(object, (String)"reference");
        object = Array.newInstance(object.getClass().getComponentType(), n);
        if (object == null) throw new NullPointerException("null cannot be cast to non-null type kotlin.Array<T>");
        return object;
    }

    public static final <T> int contentDeepHashCode(T[] TArray) {
    ...
    public static final /* synthetic */ <T> T[] orEmpty(T[] objectArray) {
    ...
    public static final /* synthetic */ <T> T[] toTypedArray(Collection<? extends T> objectArray) {
        Intrinsics.checkNotNullParameter(objectArray, (String)"$this$toTypedArray");
        Intrinsics.reifiedOperationMarker((int)0, (String)"T?");
