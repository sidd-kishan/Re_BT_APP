...
public static final class ArraysKt___ArraysJvmKt.asList.8
extends AbstractList<Character>
implements RandomAccess {
    final char[] $this_asList;

    ArraysKt___ArraysJvmKt.asList.8(char[] cArray) {
        this.$this_asList = cArray;
    }

    public boolean contains(char c) {
        return ArraysKt.contains((char[])this.$this_asList, (char)c);
    }
    ...
    public int indexOf(char c) {
        return ArraysKt.indexOf((char[])this.$this_asList, (char)c);
    }
    ...
    public int lastIndexOf(char c) {
        return ArraysKt.lastIndexOf((char[])this.$this_asList, (char)c);
    }
}
