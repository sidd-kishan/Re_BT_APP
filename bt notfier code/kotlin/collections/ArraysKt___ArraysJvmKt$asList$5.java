...
public static final class ArraysKt___ArraysJvmKt.asList.5
extends AbstractList<Float>
implements RandomAccess {
    final float[] $this_asList;

    ArraysKt___ArraysJvmKt.asList.5(float[] fArray) {
    ...
    public boolean contains(float f) {
        ...
        while (true) {
            boolean bl2 = bl;
            if (n2 >= n) return bl2;
            boolean bl3 = Float.floatToIntBits(fArray[n2]) == Float.floatToIntBits(f);
            if (bl3) {
                bl2 = true;
                return bl2;
            }
    ...
    public int lastIndexOf(float f) {
        ...
        while (true) {
            int n3 = n2;
            if (n < 0) return n3;
            n3 = Float.floatToIntBits(fArray[n]) == Float.floatToIntBits(f) ? 1 : 0;
            if (n3 != 0) {
                n3 = n;
                return n3;
            }
