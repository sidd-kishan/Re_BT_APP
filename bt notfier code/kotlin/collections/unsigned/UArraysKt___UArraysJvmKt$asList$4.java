...
public static final class UArraysKt___UArraysJvmKt.asList.4
extends AbstractList<UShort>
implements RandomAccess {
    final short[] $this_asList;

    UArraysKt___UArraysJvmKt.asList.4(short[] sArray) {
        this.$this_asList = sArray;
    }

    public boolean contains_xj2QHRw(short s) {
        return UShortArray.contains_xj2QHRw((short[])this.$this_asList, (short)s);
    }

    public short get_Mh2AYeg(int n) {
        return UShortArray.get_Mh2AYeg((short[])this.$this_asList, (int)n);
    }

    public int getSize() {
        return UShortArray.getSize_impl((short[])this.$this_asList);
    }

    public int indexOf_xj2QHRw(short s) {
        return ArraysKt.indexOf((short[])this.$this_asList, (short)s);
    }

    public boolean isEmpty() {
        return UShortArray.isEmpty_impl((short[])this.$this_asList);
    }

    public int lastIndexOf_xj2QHRw(short s) {
