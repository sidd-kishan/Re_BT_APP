...
public static final class UIntProgression.Companion {
    private UIntProgression.Companion() {
    }

    public /* synthetic */ UIntProgression.Companion(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }

    public final UIntProgression fromClosedRange_Nkh28Cs(int n, int n2, int n3) {
