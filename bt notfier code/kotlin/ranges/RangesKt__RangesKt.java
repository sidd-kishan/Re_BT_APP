...
class RangesKt__RangesKt {
    public static final void checkStepIsPositive(boolean bl, Number number) {
        Intrinsics.checkNotNullParameter((Object)number, (String)"step");
        if (bl) {
            return;
        }
    ...
    private static final <T, R extends Iterable<? extends T> & ClosedRange<T>> boolean contains(R r, T t) {
        Intrinsics.checkNotNullParameter(r, (String)"$this$contains");
        boolean bl = t != null && ((ClosedRange<T>)r).contains((Comparable)t);
        return bl;
    }

    public static final ClosedFloatingPointRange<Double> rangeTo(double d, double d2) {
        return (ClosedFloatingPointRange)new ClosedDoubleRange(d, d2);
    }

    public static final ClosedFloatingPointRange<Float> rangeTo(float f, float f2) {
        return (ClosedFloatingPointRange)new ClosedFloatRange(f, f2);
    }

    public static final <T extends Comparable<? super T>> ClosedRange<T> rangeTo(T t, T t2) {
        Intrinsics.checkNotNullParameter(t, (String)"$this$rangeTo");
        Intrinsics.checkNotNullParameter(t2, (String)"that");
        return (ClosedRange)new ComparableRange(t, t2);
    }
}
