...
public final class TuplesKt {
    ...
    public static final <T> List<T> toList(Pair<? extends T, ? extends T> pair) {
        Intrinsics.checkNotNullParameter(pair, (String)"$this$toList");
        return CollectionsKt.listOf((Object[])new Object[]{pair.getFirst(), pair.getSecond()});
    }

    public static final <T> List<T> toList(Triple<? extends T, ? extends T, ? extends T> triple) {
        Intrinsics.checkNotNullParameter(triple, (String)"$this$toList");
        return CollectionsKt.listOf((Object[])new Object[]{triple.getFirst(), triple.getSecond(), triple.getThird()});
    }
}
